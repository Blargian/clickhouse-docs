...
- **Enhanced data types** - Native support for types such as [JSON](/sql-reference/data-types/newjson), [LowCardinality](/sql-reference/data-types/lowcardinality), and [Enum](/sql-reference/data-types/enum), enabling more compact storage and faster processing.
